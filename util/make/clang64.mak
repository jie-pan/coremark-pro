...
# Tools Root Directory
 TOOLS	= /usr
# TOOLS	= /opt/intel/oneapi/compiler/2021.3.0/linux/
# For Solaris
#TOOLS	= /usr/local
# For Solaris
...
AS		= $(TOOLS)/bin/llvm-as-12

#LD		= $(TOOLS)/bin/ld.lld
LD		= $(TOOLS)/bin/clang-12
EXEOUT	= -o
EXE		= .exe

AR		= $(TOOLS)/bin/llvm-ar-12
RANLIB	= $(TOOLS)/bin/llvm-ranlib-12
NM		= $(TOOLS)/bin/llvm-nm-12
LIBTYPE	= .a
LIBOUT	= 
...
#COMPILER_FLAGS	= -Ofast -funroll-loops -flto -static -mfpmath=sse -march=native $(CDEFN)NDEBUG $(CDEFN)HOST_EXAMPLE_CODE=1 -std=gnu99
COMPILER_FLAGS	= -Ofast -funroll-loops -flto -static -mfpmath=sse -march=native $(CDEFN)NDEBUG $(CDEFN)HOST_EXAMPLE_CODE=1 -std=gnu99
...
#LINKER_FLAGS	+=  -static -flto -use-gold-plugin
LINKER_FLAGS	+=  -static -flto -fuse-ld=lld
